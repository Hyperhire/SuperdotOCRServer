...
class PGHead(nn.Layer):
    ...
    def __init__(self, in_channels, **kwargs):
        ...
        self.conv_f_char2 = ConvBNLayer(
            in_channels=128,
            out_channels=256,  # 다른 dictionary로 바꿀때 수정 필요한 부분(원래 128)
            kernel_size=3,
            stride=1,
            padding=1,
            act='relu',
        ...
        self.conv_f_char3 = ConvBNLayer(
            in_channels=256, # 다른 dictionary로 바꿀때 수정 필요한 부분(원래 128)
            out_channels=512,  # 다른 dictionary로 바꿀때 수정 필요한 부분(원래 256)
            kernel_size=1,
            stride=1,
            padding=0,
            act='relu',
        ...
        self.conv_f_char4 = ConvBNLayer(
            in_channels=512, # 다른 dictionary로 바꿀때 수정 필요한 부분(원래 256)
            out_channels=512, # 다른 dictionary로 바꿀때 수정 필요한 부분(원래 256)
            kernel_size=3,
            stride=1,
            padding=1,
        ...
        self.conv_f_char5 = ConvBNLayer(
            in_channels=512,  # 다른 dictionary로 바꿀때 수정 필요한 부분(원래 256)
            out_channels=1024, # 다른 dictionary로 바꿀때 수정 필요한 부분(원래 256)
            kernel_size=1,
            stride=1,
            padding=0,
            act='relu',
        ...
        self.conv3 = nn.Conv2D(
            in_channels=1024, # 다른 dictionary로 바꿀때 수정 필요한 부분(원래 256)
            out_channels=1854, # 다른 dictionary로 바꿀때 수정 필요한 부분(원래 37)
            kernel_size=3,
            stride=1,
            padding=1,
            groups=1,
