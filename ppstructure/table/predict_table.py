...
class TableSystem(object):
    ...
    def __call__(self, img):
        ...
        print('structure_res', structure_res)
    ...
    def rebuild_table(self, structure_res, dt_boxes, rec_res):
        ...
        print('pred_structures', pred_structures)
...
args.image_dir = './KEPCO_test_image/hangul_table.PNG'
# args.e2e_model_dir='./output/KEPCO_sample_receipt_ds_wordLevel_3waysoft_0_2243_v4/best_accuracy'
args.det_model_dir = './ppstructure/weights/en_ppocr_mobile_v2.0_table_det_infer'
args.rec_model_dir = './ppstructure/weights/en_ppocr_mobile_v2.0_table_rec_infer'
args.rec_char_dict_path = './ppocr/utils/dict/table_dict.txt'
args.table_model_dir = './ppstructure/weights/en_ppocr_mobile_v2.0_table_structure_infer'
args.character_dict_path = './ppocr/utils/dict/table_structure_dict.txt'
...
def main(args):
    ...
    # i, image_file = 0, image_file_list[0]
